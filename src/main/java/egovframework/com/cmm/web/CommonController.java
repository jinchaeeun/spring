...
public class CommonController {
	...
	public String selectView(@ModelAttribute("searchVO") ComDefaultVO searchVO,@PathVariable("var1") String var1,HttpServletRequest req ,ModelMap model) throws Exception {
