...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/js/swiper.min.css">
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/js/fullpage.min.css">
...
<link rel="stylesheet" media="screen and (max-width: 480px)"
	href="${pageContext.request.contextPath}/css/480.css">

<!-- 태블릿 세로-->
<link rel="stylesheet"
	media="screen and (min-width: 481px) and (max-width: 720px)"
	href="${pageContext.request.contextPath}/css/720.css">
